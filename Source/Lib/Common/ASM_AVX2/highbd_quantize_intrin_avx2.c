...
void eb_aom_quantize_b_avx2(const TranLow *coeff_ptr, intptr_t n_coeffs,
...
static INLINE void quantize_highbd(const __m256i *qp, __m256i *c,
    const int16_t *iscan_ptr, TranLow *qcoeff,
...
static INLINE void quantize_64X64_highbd(const __m256i *qp, __m256i *c,
    const int16_t *iscan_ptr, TranLow *qcoeff,
    TranLow *dqcoeff, __m256i *eob) {
    const __m256i abs = _mm256_abs_epi32(*c);
    const __m256i flag1 = _mm256_cmpgt_epi32(abs, qp[0]);
...
static INLINE void quantize_32x32_highbd(const __m256i *qp, __m256i *c,
    const int16_t *iscan_ptr, TranLow *qcoeff,
    TranLow *dqcoeff, __m256i *eob) {
    const __m256i abs = _mm256_abs_epi32(*c);
    const __m256i flag1 = _mm256_cmpgt_epi32(abs, qp[0]);

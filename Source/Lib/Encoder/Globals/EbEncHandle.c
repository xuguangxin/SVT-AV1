...
EB_API EbErrorType eb_deinit_encoder(EbComponentType *svt_enc_component){
    ...
    if (handle) {
        eb_system_resource_shutdown(handle->input_buffer_resource_ptr);
        eb_system_resource_shutdown(handle->resource_coordination_results_resource_ptr);
        eb_system_resource_shutdown(handle->picture_analysis_results_resource_ptr);
        eb_system_resource_shutdown(handle->picture_decision_results_resource_ptr);
        eb_system_resource_shutdown(handle->motion_estimation_results_resource_ptr);
        eb_system_resource_shutdown(handle->initial_rate_control_results_resource_ptr);
        eb_system_resource_shutdown(handle->picture_demux_results_resource_ptr);
        eb_system_resource_shutdown(handle->rate_control_tasks_resource_ptr);
        eb_system_resource_shutdown(handle->rate_control_results_resource_ptr);
        eb_system_resource_shutdown(handle->enc_dec_tasks_resource_ptr);
        eb_system_resource_shutdown(handle->enc_dec_results_resource_ptr);
        eb_system_resource_shutdown(handle->entropy_coding_results_resource_ptr);
        eb_system_resource_shutdown(handle->dlf_results_resource_ptr);
        eb_system_resource_shutdown(handle->cdef_results_resource_ptr);
        eb_system_resource_shutdown(handle->rest_results_resource_ptr);
    }
